...
app.view.VerticalMenu.prototype = {
	...
	calculateMenuPosition: function() {
		this.verticalMenuTop = this.verticalMenu.offsetTop;
		this.verticalMenuHeight = this.verticalMenu.clientHeight;
		this.content = $(this.sliderContainerId);
	},

	setPosition: function() {
		var contentHeight = this.content.clientHeight - this.contentMargin;
